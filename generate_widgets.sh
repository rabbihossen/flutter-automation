...
WIDGET_DIR="lib/feature/${VIEW_NAME}/widget"
SCREEN_FILE="lib/feature/${VIEW_NAME}/screen/${VIEW_NAME}.dart"
...
class $WIDGET_CLASS_NAME extends GetView<$CONTROLLER_CLASS_NAME> {
  ...
  Widget build(BuildContext context) {
    return Card(
      elevation: 0,
      margin: Space.left.l15 + Space.right.r15 + Space.top.t15,
